        ...
        <HelmetProvider>
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/sign-up/*" element={isClerkEnabled ? <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4"><SignUp routing="path" path="/sign-up" signInUrl="/sign-in" /></div> : <CustomSignUp />} />
